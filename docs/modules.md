...
* [API & Référence technique](#api--référence-technique)
* [FAQ](#faq)
...
La section API regroupe :

* endpoints REST exposés par chaque module ;
* classes Java publiques et interfaces d’extension pour les développeurs de modules ;
* événements et schémas JSON utilisés.

**Exemple d’appel REST**

```http
GET /om-analytics/v1/summary?start=2025-09-01T00:00:00Z&end=2025-09-07T23:59:59Z
...
* **Support technique** : [support@operametrix.com](mailto:support@operametrix.example)
* **Ventes / licences** : [sales@operametrix.com](mailto:sales@operametrix.example)
